...
{
    class ODSDataExtractEntity : IWritableEntity, IReadableEntity
    {
        ...
        public string DataRow
        {
            get
            {
                return $"{ODSNo}\t{ID}\t{Remark}\t{Condition}\t{TableType}\t{Type}\t{QT}\n";
            }
        }

        public ODSDataExtractEntity(string dataRow)
        {
        ...
        public void SetProperties(string dataRow)
        {
            ...
            QT = dataRow.Substring(TypeIndex + 1);
