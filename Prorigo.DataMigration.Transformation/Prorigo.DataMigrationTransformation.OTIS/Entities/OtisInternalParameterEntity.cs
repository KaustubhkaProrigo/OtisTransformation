...
{
    class OtisInternalParameterEntity : IReadableEntity
    {
        ...
        public OtisInternalParameterEntity(string dataRow)
        {
        ...
        public void SetProperties(string dataRow)
        {
            ...
            var Data_TypeIndex = dataRow.IndexOf('\t', Function_ApplicationIndex + 1);
            Data_Type = dataRow.Substring(Function_ApplicationIndex + 1, Data_TypeIndex - Function_ApplicationIndex - 1);

            var LoopIndex = dataRow.IndexOf('\t', Data_TypeIndex + 1);
            Loop = dataRow.Substring(Data_TypeIndex + 1, LoopIndex - Data_TypeIndex - 1);
            ...
            var Sub_SystemIndex = dataRow.IndexOf('\t', Usage_PriorityIndex + 1);
            Sub_System = dataRow.Substring(Usage_PriorityIndex + 1, Sub_SystemIndex - Usage_PriorityIndex - 1);

            var ModuleIndex = dataRow.IndexOf('\t', Sub_SystemIndex + 1);
            Module = dataRow.Substring(Sub_SystemIndex + 1, ModuleIndex - Sub_SystemIndex - 1);
