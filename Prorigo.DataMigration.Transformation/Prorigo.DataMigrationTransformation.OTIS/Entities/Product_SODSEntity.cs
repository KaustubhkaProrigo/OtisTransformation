...
{
    class Product_SODSEntity : IWritableEntity, IReadableEntity
    {
        ...
        public string DataRow
        {
            get
            {
                return $"{SODSNO}\t{ID}\t{SS_No}\t{Description}\t{Condition}\t{ODS_No}\t{QT}\n";
            }
        }

        public Product_SODSEntity(string dataRow)
        {
        ...
        public void SetProperties(string dataRow)
        {
            ...
            QT = dataRow.Substring(ODS_NoIndex + 1);
